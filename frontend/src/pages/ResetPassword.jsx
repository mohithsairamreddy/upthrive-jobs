...
export default function ResetPassword() {
  ...
  // Recovery links can be implicit (hash) or PKCE (?code=...). Supabase may also put errors in the
  // hash (#error=...). PKCE completes with SIGNED_IN while GoTrue only emits PASSWORD_RECOVERY for
  // implicit recovery — so we also trust getSession() after initialize(), only when the URL looks
  // like an auth callback (including error callbacks).
  useEffect(() => {
